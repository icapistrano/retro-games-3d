...
const AVATAR_PATH = "public/avatar.glb";
const ANIMATION_PATH = "public/animations.glb";
...
export const Avatar: FunctionComponent<{
  ...
  const { nodes, materials } = useGLTF(AVATAR_PATH) as GLTFResult;
